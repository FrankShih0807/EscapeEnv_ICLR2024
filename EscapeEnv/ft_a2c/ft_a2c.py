...
class FT_A2C(ActorCriticAgent):
    ...
    def _build_estimator(self):
        self.ac_estimator = FT_A2CEstimator(network=self.network, learning_rate=self.learning_rate, optimizer_kwargs=self.optimizer_kwargs, estimator_kwargs=self.estimator_kwargs, device=self.device)
